...
var alomApp = angular.module("alom", ['AddwindowsMain','ngRoute']);
...
//##################### Controller for selection  window to add it ###########
// alomApp.controller("mainSelects", ['$scope', '$http', 'myCache', function ($scope, $http, myCache) {
//
//
//     (function init() {
